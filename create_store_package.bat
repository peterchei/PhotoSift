...
echo                            Square71x71Logo="Assets\Square71x71Logo.png" >> "store_package\AppxManifest.xml"
echo                            Square310x310Logo="Assets\Square310x310Logo.png" >> "store_package\AppxManifest.xml"
echo                            StoreLogo="Assets\StoreLogo.png" >> "store_package\AppxManifest.xml"
