...
echo     ^<Logo^>app.ico^</Logo^> >> "store_package\AppxManifest.xml"
echo   ^</Properties^> >> "store_package\AppxManifest.xml"
...
echo                            Square150x150Logo="app.ico" >> "store_package\AppxManifest.xml"
echo                            Square44x44Logo="app.ico" >> "store_package\AppxManifest.xml"
